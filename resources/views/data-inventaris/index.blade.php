...
@if (auth()->user()->role == "admin")
                    ...
                    <div class="form-group">
                    <div class="input-group">
                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-hospital-alt"></i></span></div>
...
@push('js')
    ...
    <script>
        ...
        jQuery(document).ready(function() {
         ...
         $('#filter_pengguna,#filter_rs,#filter_departemen').change(function(){
