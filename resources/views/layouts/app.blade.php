...
</svg></span><span class="kt-menu__link-text">Kalibrasi</span></a></li>
                                        @endcan
                            @can('masalah')
...
</svg></span><span class="kt-menu__link-text">Riwayat Perbaikan</span></a></li>
                                        @endcan
...
</svg></span><span class="kt-menu__link-text">Laporan</span><i
...
<li class="kt-menu__item  @if (request()->segment(2) == 'master-merk')
        ...
        aria-haspopup="true"><a href="{{ route('Permission.index') }}" class="kt-menu__link "><i
            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
