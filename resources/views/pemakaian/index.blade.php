...
@section('content')
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            <form method="GET" action="{{ route('pemakaian.excel_pemakaian') }}" id="cetak-laporan">
                ...
                <div class="row col-12">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="nama" class="col-form-label">Ke Depertemen</label>
                           <select name="tujuan" class="form-control">
                            <option value="">-- Pilih Departemen Tujuan --</option>
                        <option value="ELEKTRO-MEDIS">Elektromedis</option>
